...
- Navigate to **EC2** in AWS and click **Launch Instance**  
- Select **Ubuntu Server**  
- Create a new **Key Pair** (SSH) and download the `.pem` file  
- Select the **VPC** and **public subnet** created in Project 02  
...
- Open **MobaXterm**, start a new SSH session  
- Enter the EC2 **public IP** and username `ubuntu`  
- Import the downloaded **key pair**  
...
![Domain Live Ip](images/08-domain-live.png)
